    ...
    <div id="page-room">
      ...
      <main>
        ...
        <div className="question-list">
          {questions.map(question => { // unico jeito de fazer for no react
            return (
              <Question
                key={question.id}
              ...
              >
                <button
                  ...
                  type="button"
                  aria-label="Marcar como gostei"//o que o botao faz, para acessibilidade
                  onClick={() => handleLikeQuestion(question.id, question.likeId)} // funçao que precisa de parametro
                >
